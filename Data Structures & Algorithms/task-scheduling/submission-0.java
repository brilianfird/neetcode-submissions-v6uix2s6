    ...
    public int leastInterval(char[] tasks, int n) {
        ...
        while (!heap.isEmpty() || !cooldown.isEmpty()) {
            ...
            while (!cooldown.isEmpty() && cooldown.peek()[0] <= cycle) {
                ...
                System.out.println("Done cooldown: " + (char) currCooldown[2] + " cycle: " + currCooldown[0] + "/" + cycle);
            ...
            System.out.println((char)currTask[1] + "," + currTask[0]);
            if (currTask[0] != 1) {
                cooldown.offer(new int[]{cycle+n+1, currTask[0]-1, currTask[1]});
                System.out.println("Cooldown added: " + (cycle+n+1) + " char: " + (char) currTask[1]);
            }
        }
